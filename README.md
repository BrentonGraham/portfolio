...
| Survival Analysis | Identifying risk factors associated with stroke incidence using data from the Framingham study. Further estimating the 10-year probability of stroke in different risk-profile groups using a LASSO-penalized Cox regression framework. | [Code](https://github.com/BrentonGraham/inference-anschutz/tree/main/adv-methods-3-survival-analysis/code) | [Report](https://github.com/BrentonGraham/inference-anschutz/blob/main/adv-methods-3-survival-analysis/reports/survival-analysis-report.pdf) |
| Variable Selection Comparison | Using a simulation approach to compare the performance of automated variable selection methods (stepwise selection, LASSO, elastic net). Multiple data set configurations are simulated to assess the effects of sample size and multicollinearity on performance. | [Code](https://github.com/BrentonGraham/inference-anschutz/tree/main/adv-methods-4-variable-selection-sim/code) | [Report](https://github.com/BrentonGraham/inference-anschutz/blob/main/adv-methods-4-variable-selection-sim/reports/variable-selection-sim-report.pdf) |
